...
int main(void)
{
	...
	/*Create tasks*/
	xTaskCreate(TaskStartCode,NULL,130,NULL,2,NULL);
	xTaskCreate(TaskPatternCode,NULL,90,NULL,1,NULL);
	xTaskCreate(TaskCalculatorCode,NULL,120,NULL,3,NULL);
	//xTaskCreate(TaskResetCode,NULL,85,NULL,4,NULL);
	/*start Scheduler */
	vTaskStartScheduler();
